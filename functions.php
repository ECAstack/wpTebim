...
function wd_admin_menu_rename() {
	global $menu; // catch / hook global MENU
	global $submenu; // catch / hook global sub menu
	$menu[5][0] = 'Pokoje';
	$submenu['edit.php'][5][0] = 'Wszystkie pokoje'; // Change name of all posts to  room's
	$submenu['post-new.php'][5][10] = 'Dodaj nowy pokój'; // Change name of all posts to  room's
	$submenu['edit.php'][5][15] = 'Kategorie pokoi'; // Change name of all posts to  room's
	$submenu['edit.php'][5][16] = 'Tagi pokoi'; // Change name of all posts to  room's
}
